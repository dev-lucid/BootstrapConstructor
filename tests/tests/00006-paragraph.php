...
$html .= bsc::create('paragraph',array('text'=>'test5','align'=>'right','emphasis'=>'warning'))->render()."\n";
$html .= bsc::create('paragraph',array('text'=>'test6','align'=>'center','emphasis'=>'muted'))->render()."\n";
